...
**Generated:** 2026-08-25T13:31:07.988Z  
...
| **Actual LEGIT**      | FP = 43 | TN = 257 |

| Metric (mule class) | Value |
|---|---:|
| Accuracy | 80.75% |
| Precision | 0.6055 (60.55%) |
| Recall (mule detection rate) | 0.6600 (66.00%) |
| F1 (mule) | 0.6316 |
| AUC — calibrated_score | 0.8201 |
| AUC — risk_score (0–100) | 0.8201 |
...
|---|---:|---:|---:|
| Planted mules | 100 | 0.5886 | 58.86 |
| Legit accounts | 300 | 0.4302 | 43.02 |
...
|---|---:|---:|---:|---:|
| fan_in | 25 | 20 | 80.00% | 0.6502 |
| fan_out | 25 | 19 | 76.00% | 0.6053 |
| pass_through | 25 | 16 | 64.00% | 0.5966 |
| circular | 25 | 11 | 44.00% | 0.5022 |
...
Rank discrimination (AUC on the decision variable, `calibrated_score`) is **0.820** — good; clearly above the 0.5 chance line.

At the engine's own operating point, recall of planted mules is **66.00%** at precision **0.606** (accuracy 80.75% vs. majority-class baseline 75.00%).
