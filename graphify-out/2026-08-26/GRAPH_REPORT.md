...
## Corpus Check
- 93 files · ~10,214,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 711 nodes · 960 edges · 63 communities (43 shown, 20 thin omitted)
...
Cohesion: 0.11
Nodes (19): 3d-force-graph, lucide-react, next, dependencies, 3d-force-graph, lucide-react, next, plotly.js (+11 more)
...
Cohesion: 0.09
Nodes (25): metadata, AnalyticsContent(), AnalyticsData, CHART_COLORS, PATTERN_LINES, Controls, escapeHtml(), GalaxyApiLink (+17 more)
...
Cohesion: 0.05
Nodes (38): metadata, metadata, metadata, metadata, AccountsContent(), RISK_OPTIONS, AlertsContent(), DashboardContent() (+30 more)
...
Cohesion: 0.06
Nodes (35): Account, accountNames, accounts, Alert, alerts, banks, flagTypes, GraphEdge (+27 more)
...
## Knowledge Gaps
- **272 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+267 more)
...
- **Why does `LoadingState()` connect `DashboardContent.tsx` to `MuleGalaxy.tsx`?**
