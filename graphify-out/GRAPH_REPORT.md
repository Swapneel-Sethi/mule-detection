...
## Corpus Check
- 96 files · ~10,163,031 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 703 nodes · 950 edges · 63 communities (47 shown, 16 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2b655c4`
...
### Community 2 - "NetworkGraph.tsx"
Cohesion: 0.05
Nodes (30): AnalyticsContent(), AnalyticsData, CHART_COLORS, PATTERN_LINES, formatINR(), GraphAccount, GraphTransaction, HierarchicalHypergraph() (+22 more)
...
### Community 6 - "transactionXgboost.ts"
Cohesion: 0.14
...
### Community 9 - "train_transaction_model.py"
Cohesion: 0.12
...
### Community 15 - "multi-agent-orchestration.skill"
Cohesion: 0.17
...
### Community 16 - "recompute_ml_scores.py"
Cohesion: 0.27
...
### Community 20 - "import-csv-to-firestore.js"
Cohesion: 0.31
...
### Community 22 - "useFirestoreData.ts"
Cohesion: 0.22
...
### Community 28 - "generate_all_synthetic_data"
Cohesion: 0.36
...
### Community 29 - "AccountsContent.tsx"
Cohesion: 0.29
...
## Knowledge Gaps
- **252 isolated node(s):** `Account`, `Alert`, `DetectedPattern`, `DetectionResult`, `EdgeData` (+247 more)
...
- **Why does `useFirestoreData()` connect `useFirestoreData.ts` to `AlertsContent.tsx`, `normalizers.ts`, `AccountsContent.tsx`, `utils.ts`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
...
- **Should `NetworkGraph.tsx` be split into smaller, more focused modules?**
