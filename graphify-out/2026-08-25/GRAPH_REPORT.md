...
## Corpus Check
- 93 files · ~10,213,823 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 706 nodes · 966 edges · 62 communities (42 shown, 20 thin omitted)
...
Cohesion: 0.07
Nodes (32): metadata, AnalyticsContent(), AnalyticsData, CHART_COLORS, PATTERN_LINES, Controls, escapeHtml(), GalaxyApiLink (+24 more)
...
## Knowledge Gaps
- **270 isolated node(s):** `Account`, `Alert`, `DetectedPattern`, `DetectionResult`, `EdgeData` (+265 more)
